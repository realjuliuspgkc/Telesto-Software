...
GLOBAL FUNCTION _PRINT_TELEM { // Show things on the screen for debug
   ...
   // altitude DONE, speed DONE
    ...
    print "Vehicle Pitch: " + round(90 - vectorAngle(ship:up:forevector, ship:facing:forevector), 3) + " Deg" + "         " at (0,10).
    print "---------- Vehicle Orbital Details ----------" at (0,11).
    print "Vehicle Apogee: " + floor(ship:apoapsis / 1000, 1) + " KM" + "         " at (0,12).
    print "Time to Apogee: " + _CLOCK_TIME(eta:apoapsis) + "         " at (0,13).
    print "Vehicle Perigee: " + floor(ship:periapsis / 1000, 1) + " KM" + "         " at (0,14).
    print "Time to Periapsis: " + _CLOCK_TIME(eta:periapsis) + "         " at (0,15).
    print "Vehicle Inclination: " + floor(orbit:inclination) + " Deg" + "         " at (0,16).
    print "---------- Stage 2 Propellant Levels ----------" at (0,17).
    print "CH2: " + floor(_S2_PROPELLANT_CH2_AMOUNT) + " L" + "         " at (0,18).
    print "OX: " + floor(_S2_PROPELLANT_OX_AMOUNT) + " L" + "         " at (0,19).
    print "Overall: " + _PROPELLANT_PERCENTAGE("Stage 2") + "         " at (0,20).
    print "---------- Stage 1 Propellant Levels ----------" at (0,21).
    print "LqdFuel: " + floor(_S1_PROPELLANT_LF_AMOUNT) + " L" + "         " at (0,22).
    print "OX: " + floor(_S1_PROPELLANT_OX_AMOUNT) + " L" + "         " at (0,23).
    print "Overall: " + _PROPELLANT_PERCENTAGE("Stage 1") + "         " at (0,24).
}
